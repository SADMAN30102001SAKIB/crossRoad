let scene, camera, renderer, orbitControl, stats;
    ...
    class Sound{
        constructor(listenerParent){
            ...
            audioLoader.load( 'https://badasstechie.github.io/CrossyRoad/audio/death2.wav', buffer =>{
            ...
            audioLoader.load( 'https://badasstechie.github.io/CrossyRoad/audio/shred.mp3', buffer =>{
